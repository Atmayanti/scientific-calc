<div class="luarkalkulator">
    <form name="Acalc">
        <table class="calculator" cellspacing="0" cellpadding="1" style="margin-left:auto;margin-right:auto" border="1">
            <tr>
                <td colspan="5"><input id="display" name="display" value="0" size="50" maxlength="25"></td>
            </tr>
            <tr>
